        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              <code className="bg-muted px-2 py-0.5 rounded text-foreground">GET /api/explore</code> &mdash; Get an overview of everything available on AgentPay.
            </p>
...
if (cheapest.priceUsdc <= MAX_AUTO_PAYMENT && balance >= cheapest.priceUsdc) {
  ...
  return result
      ...
      <Card className="bg-primary/10 border-primary/20">
        ...
        <CardContent className="space-y-4">
          <p className="text-foreground text-sm">Set up your agent with AgentPay:</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
