      ...
      <section>
        <div className="flex flex-col gap-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground">
            Learn how to build with AgentPay.
          </h1>
  ...
  (req, res) => {
    res.json({ data: 'premium content' });
      ...
      <section className="border-t border-border pt-12">
        <h2 className="text-2xl font-bold text-foreground mb-6">What is AgentPay?</h2>
        <div className="space-y-4 text-muted-foreground">
          <p>
            AgentPay is an AI-native marketplace for creating payment-gated APIs and content using the HTTP 402 Payment Required status code.
            It enables automatic, programmable payments for AI agents, APIs, and digital commerce.
          </p>
          <p>
            Built on Base with <strong className="text-primary">USDC stablecoin</strong>, AgentPay makes it easy to:
          </p>
      ...
      <footer className="mt-12 mb-12 flex flex-wrap justify-between gap-8 py-8 border-t border-border">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-foreground">AgentPay Docs</span>
          </div>
          <p className="text-xs text-muted-foreground">© 2025 AgentPay. All rights reserved.</p>
        </div>
