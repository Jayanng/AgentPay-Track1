        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            <div className="size-20 rounded-2xl bg-primary/10 flex items-center justify-center shadow-lg shadow-primary/10">
              <Image src="/logo.png" alt="AgentPay" width={48} height={48} className="h-12 w-auto" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Your public profile will be at: agentpay.app/@{username || "yourname"}
              </p>
              {isAvailable === false && (
